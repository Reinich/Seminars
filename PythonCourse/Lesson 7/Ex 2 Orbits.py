...
# 1 с помощью словаря, где ключ - площадь орбиты
orbits = [(1, 3), (2.5, 10), (7, 2), (6, 6), (4, 3)]
find_farthest_orbit = dict([(a * b, (a, b)) for (a, b) in orbits if a != b])
print(*find_farthest_orbit[max(find_farthest_orbit.keys())])

# 2 с помощью списка, где ищем максимум по индексу
orbits = [(1, 3), (2.5, 10), (7, 2), (6, 6), (4, 3)]
find_farthest_orbit = [(a * b, (a, b)) for (a, b) in orbits if a != b]
